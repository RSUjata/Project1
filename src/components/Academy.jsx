...
//   useEffect(() => {
//     const durations = stats.map((stat) => 1500); // 1.5s duration per counter
//     const steps = 30;
...
//           <div>
//             <h2 className="text-3xl font-bold mb-2">Our Academy</h2>
//             <p className="text-gray-300 text-base sm:text-lg leading-relaxed">
//               Eurisko believes in human potential and invests heavily in the capabilities of new generations to practically teach them about emerging technologies.
//             </p>
//           </div>
...
//                 <div className="text-2xl font-bold text-white">{counters[i]}{stat.value > 10 ? '+' : ''}</div>
