...
{/* Who We Are Section */}
<div className="w-full bg-white py-16 px-4 sm:px-10">
  <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-start justify-between gap-12">
    ...
    <div className="md:w-1/2 space-y-6">
      ...
      <p className="text-gray-700 text-xl sm:text-2xl leading-tight max-w-full font-serif">
    ...
    <div className="md:w-1/2 flex justify-center">
      <div className="w-full max-w-full h-[600px] sm:h-[700px] md:h-[800px] flex items-center justify-center">
        <img
          src={who}
          alt="Eurisko Team"
