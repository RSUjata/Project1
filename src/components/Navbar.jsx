...
//         <div className="flex flex-wrap items-center justify-start gap-4 sm:gap-6 md:gap-8 text-lg sm:text-xl md:text-2xl lg:text-2xl font-semibold ml-4 sm:ml-6 md:ml-10 lg:ml-20">
//           <div
//             className="relative group"
//             onMouseEnter={() => setMenuOpen('services')}
//             onMouseLeave={() => setMenuOpen(null)}
//           >
//             <button className="flex items-center hover:text-yellow-400 border-b-2 border-transparent group-hover:border-yellow-300 transition-all duration-200">
...
//                     <button
//                       key={index}
//                       onClick={() => handleLinkClick(`/industries/${item.name.toLowerCase()}`)}
//                       className="flex items-center gap-2 p-3 hover:bg-gray-100 rounded-md text-left w-full"
//                     >
//                       {item.icon}
//                       <span>{item.name}</span>
...
//           <Link
//             to="/offshore"
//             className="hover:text-yellow-400 border-b-2 border-transparent hover:border-yellow-300 transition-all duration-200"
//           >
...
//           <Link
//             to="/contact"
//             className={`rounded-full px-6 py-2 font-semibold transition-colors duration-200 border-2 ${
//               isScrolled
//                 ? 'text-black border-black hover:bg-purple-100'
//                 : 'text-white border-white hover:bg-purple-400'
//             }`}
//           >
//             Get in touch now
//           </Link>
      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-start gap-4 sm:gap-6 md:gap-8 text-lg sm:text-xl md:text-2xl lg:text-2xl font-semibold ml-4 sm:ml-6 md:ml-10 lg:ml-20">
          <div
            ...
            onMouseLeave={() => setMenuOpen(null)}
          >
            <button className="flex items-center border-b-2 border-transparent group-hover:border-yellow-300 transition-all duration-200">
              Services <HiChevronDown className="ml-1" />
            </button>
            {menuOpen === 'services' && (
              <div className="fixed top-[100px] left-[5%] md:left-[10%] w-[90%] md:w-[80%] bg-white text-black rounded-xl shadow-xl p-6 z-40">
          ...
          <Link
            to="/offshore"
            className="border-b-2 border-transparent hover:border-yellow-300 transition-all duration-200"
          >
            Offshore Development
          </Link>
