    ...
    return (
        <div className="bg-white text-gray-800">
            ...
            <div className="bg-black text-white min-h-[40vh] flex flex-col items-center justify-center px-4 text-center relative">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 tracking-tight">Offshore Software Development</h1>
            ...
            <div className="max-w-7xl mx-auto px-6 py-16">
                <h2 className="text-3xl sm:text-4xl font-bold text-black mb-6">Why Choose Eurisko for Offshore Software Development?</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
                    ...
                    <div>
                        <h3 className="text-2xl sm:text-3xl font-semibold mb-4">Proven Expertise</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
                    ...
                    <div>
                        <h3 className="text-2xl sm:text-3xl font-semibold mb-4">Scalable Teams</h3>
                        <p className="text-lg text-gray-600">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
                    ...
                    <div>
                        <h3 className="text-2xl sm:text-3xl font-semibold mb-4">Agile Methodology</h3>
                        <p className="text-lg text-gray-600">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-16">
                    ...
                    <div>
                        <h3 className="text-2xl sm:text-3xl font-semibold mb-4">Cost Savings</h3>
                        <p className="text-lg text-gray-600">
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-black mb-6">Our Offshore Software Development Services</h2>
                <p className="text-lg sm:text-xl text-gray-700 mb-8">
